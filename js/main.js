...
video.addEventListener("playing", () => {
  ...
  setInterval(async () => {
    ...
    if (resizedDetections && Object.keys(resizedDetections).length > 0) {
      ...
      if (emotion === "happy" || emotion === "neutral" || emotion === "excited") {
        emotion = "You're Fresh. Keep it Up!"; // Change "neutral" to "haggard"
      } else {
      ...
      document.getElementById("emotion").innerText = `Freshness Status - ${emotion}`;
    }
  }, 10);
});
